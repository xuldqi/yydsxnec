...
- 如果不加固的话：
```
cd  ProtectedApkResignerForWalle/lib  && java -jar walle-cli-all.jar batch -f /Users/xuyimin/AndroidStudioProjects/BroDong/ProtectedApkResignerForWalle/channel  /Users/xuyimin/AndroidStudioProjects/BroDong/app/build/outputs/apk/release/app-release.apk
...
- 如果不加固的话：
```
cd  ProtectedApkResignerForWalle/lib  && java -jar walle-cli-all.jar batch -f /Users/xuyimin/workspace/code/WSport/ProtectedApkResignerForWalle/channel  /Users/xuyimin/workspace/code/WSport/app/release/steps_release.apk
