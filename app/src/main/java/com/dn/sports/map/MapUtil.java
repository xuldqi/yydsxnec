...
//
//import static com.dn.sports.map.BitmapUtil.bmArrowPoint;
//import static com.dn.sports.map.BitmapUtil.bmEnd;
//import static com.dn.sports.map.BitmapUtil.bmStart;
//
///**
...
//    }
//
//    public void init(MapView view,int color) {
//        mapView = view;
...
//    }
//
//    public static LatLng convertTraceLocation2Map(long la, long lo) {
//        LatLng currentLatLng = new LatLng(la, lo);
//        return currentLatLng;
//    }
//
//    public static LatLng convertTraceLocation2Map(Location location) {
//        if (null == location) {
//            return null;
//        }
//        double latitude = location.getLatitude();
...
//            if (screenPoint.y < 200 || screenPoint.y > StepApplication.screenHeight - 500
//                    || screenPoint.x < 200 || screenPoint.x > StepApplication.screenWidth - 200
//                    || null == mapStatus) {
...
//     * 绘制历史轨迹
//     */
//    public void drawHistoryTrack(List<LatLng> points, SortType sortType,float level) {
//        // 绘制新覆盖物前，清空之前的覆盖物
//        baiduMap.clear();
