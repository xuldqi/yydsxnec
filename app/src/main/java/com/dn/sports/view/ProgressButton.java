...
public class ProgressButton extends AppCompatButton {
    ...
    public void setDrawableButtonColor(int res){
        mDrawableButton.setColor(getResources().getColor(res));
    }
    ...
    private void initialize(Context context, AttributeSet attrs) {
        ...
        int defaultButtonColor = getResources().getColor(R.color.gray);
        //Get default progress color
        int defaultProgressColor = getResources().getColor(R.color.green);
        //Get default progress background color
        int defaultBackColor = getResources().getColor(R.color.gray);
