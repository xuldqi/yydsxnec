...
public class gradual extends View {
    ...
    public gradual(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
        requestLayout();
    }
    ...
    public gradual(Context context,AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        android.graphics.LinearGradient backGradient = new LinearGradient(width, 0, 0, 0, new int[]{colorStart,colorEnd}, new float[]{0,1f}, Shader.TileMode.CLAMP);
