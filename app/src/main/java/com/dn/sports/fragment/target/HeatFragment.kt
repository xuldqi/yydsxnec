...
class HeatFragment : BaseFragment() {
    ...
    private val minStep = 0
    private val maxStep = 10000
    var targetStepNum = 2000
...
//    var targetDistanceNum = StepUserManager.getInstance().getTargetDistanceNum(requireContext())
    ...
    override fun initViewAction(view: View?) {
        targetStepNum = StepUserManager.getInstance().getTargeHeatNum(requireContext())
...
//        wheelView?.setTextSize(45f)
        ...
        customView?.setTextWidth(180,"热量")
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        btConfirm.clickDelay {
            StepUserManager.getInstance()
                .setTargetHeatNum(requireContext(), tvNum.text.toString().toInt())
